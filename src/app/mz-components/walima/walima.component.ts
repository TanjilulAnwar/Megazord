...
@Component({
  selector: 'app-walima',
  templateUrl: './walima.component.html',
  styleUrls: ['./walima.component.scss']
})
export class WalimaComponent implements OnInit {
  ngOnInit(): void {
    this.setupGsap()
 }
 setupGsap(){
...
gsap.set(".kubool", { yPercent: 1400, xPercent:100, rotate:0,opacity:0});
